...
//        extends java.io.InputStream implements ObjectInput, ObjectStreamConstants
//{
//
//    /** 代表空值 */
...
//        java.io.ObjectInputStream.FieldValues vals = defaultReadFields(curObj, curDesc);
//        if (curObj != null) {
...
//            try {
//                status = serialFilter.checkInput(new java.io.ObjectInputStream.FilterValues(clazz, arrayLength,
...
//                ex = e;
//            }
//            if (java.io.ObjectInputStream.Logging.filterLogger != null) {
//                // Debug logging of filter checks that fail; Tracing for those that succeed
//                java.io.ObjectInputStream.Logging.filterLogger.log(status == null || status == ObjectInputFilter.Status.REJECTED
//                                ? Logger.Level.DEBUG
//                                : Logger.Level.TRACE,
...
//        WeakClassKey key = new WeakClassKey(cl, java.io.ObjectInputStream.Caches.subclassAuditsQueue);
...
//        java.io.ObjectInputStream.FieldValues[] slotValues = null;
//
...
//            slotValues = new java.io.ObjectInputStream.FieldValues[slots.length];
//
...
//                } else {
//                    java.io.ObjectInputStream.FieldValues vals = defaultReadFields(obj, slotDesc);
//                    if (slotValues != null) {
//                        slotValues[i] = vals;
//                    } else if (obj != null) {
...
//     * method is called.
//     */
//    private java.io.ObjectInputStream.FieldValues defaultReadFields(Object obj, ObjectStreamClass desc)
//            throws IOException
//    {
//        Class<?> cl = desc.forClass();
...
//        }
//
//        return new java.io.ObjectInputStream.FieldValues(primVals, objVals);
//    }
//
...
//                                         java.io.ObjectInputStream.FieldValues values) {
...
//            extends java.io.InputStream implements DataInput
//    {
...
//
//    static {
//        SharedSecrets.setJavaObjectInputStreamAccess(java.io.ObjectInputStream::checkArray);
//    }
//
//}
//
