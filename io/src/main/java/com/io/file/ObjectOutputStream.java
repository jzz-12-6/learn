...
//        extends java.io.OutputStream implements ObjectOutput, ObjectStreamConstants
//{
//
...
//        verifySubclass();
//        bout = new java.io.ObjectOutputStream.BlockDataOutputStream(out);
//        handles = new java.io.ObjectOutputStream.HandleTable(10, (float) 3.00);
//        subs = new java.io.ObjectOutputStream.ReplaceTable(10, (float) 3.00);
//        enableOverride = false;
//        writeStreamHeader();
//        bout.setBlockDataMode(true);
//        if (extendedDebugInfo) {
//            debugInfoStack = new java.io.ObjectOutputStream.DebugTraceInfoStack();
//        } else {
//            debugInfoStack = null;
//        }
//    }
...
//            ctx.checkAndSetUsed();
//            ObjectStreamClass curDesc = ctx.getDesc();
//            curPut = new java.io.ObjectOutputStream.PutFieldImpl(curDesc);
//        }
//        return curPut;
//    }
//
...
//        Class<?> cl = getClass();
//        if (cl == java.io.ObjectOutputStream.class) {
//            return;
//        }
//        SecurityManager sm = System.getSecurityManager();
//        if (sm == null) {
//            return;
//        }
//        processQueue(java.io.ObjectOutputStream.Caches.subclassAuditsQueue, java.io.ObjectOutputStream.Caches.subclassAudits);
//        WeakClassKey key = new WeakClassKey(cl, java.io.ObjectOutputStream.Caches.subclassAuditsQueue);
//        Boolean result = java.io.ObjectOutputStream.Caches.subclassAudits.get(key);
//        if (result == null) {
//            result = auditSubclass(cl);
//            java.io.ObjectOutputStream.Caches.subclassAudits.putIfAbsent(key, result);
//        }
//        if (!result) {
//            sm.checkPermission(SUBCLASS_IMPLEMENTATION_PERMISSION);
//        }
...
//                    public Boolean run() {
//                        for (Class<?> cl = subcl;
//                             cl != java.io.ObjectOutputStream.class;
//                             cl = cl.getSuperclass())
//                        {
//                            try {
...
//                != java.io.ObjectOutputStream.class.getClassLoader();
//    }
//
//    /**
...
//        java.io.ObjectOutputStream.PutFieldImpl oldPut = curPut;
//        curPut = null;
//
//        if (extendedDebugInfo) {
...
//             */
//            if (java.io.ObjectOutputStream.this != out) {
...
//            extends java.io.OutputStream implements DataOutput
//    {
...
//            htab = new java.io.ObjectOutputStream.HandleTable(initialCapacity, loadFactor);
